...
/// This class is thread-safe and uses immutable collections for concurrent access scenarios.
/// </summary>
/// <remarks>
/// The VdotCalculator uses ImmutableDictionary for both VDOT tables to ensure thread safety
/// in multi-threaded environments. This allows multiple threads to safely access pace calculations
/// without the need for additional synchronization.
/// </remarks>
public static class VdotCalculator
{
    ...
    private static ImmutableDictionary<int, VdotEntry> CreateVdotTable()
    {
        return new Dictionary<int, VdotEntry>()
        {
            // VDOT values from 30 to 85 with corresponding race times for common distances
            { 30, new VdotEntry(30, "8:30", "9:11", "17:56", "19:19", "30:40", "1:03:46", "1:38:14", "2:21:04", "4:49:17") },
            { 31, new VdotEntry(31, "8:15", "8:55", "17:27", "18:48", "29:51", "1:02:03", "1:35:36", "2:17:21", "4:41:57") },
            { 32, new VdotEntry(32, "8:02", "8:41", "16:59", "18:18", "29:05", "1:00:26", "1:33:07", "2:13:49", "4:34:59") },
            { 33, new VdotEntry(33, "7:49", "8:27", "16:33", "17:50", "28:21", "58:54", "1:30:45", "2:10:27", "4:28:22") },
            { 34, new VdotEntry(34, "7:37", "8:14", "16:09", "17:24", "27:39", "57:26", "1:28:30", "2:07:16", "4:22:03") },
            { 35, new VdotEntry(35, "7:25", "8:01", "15:45", "16:58", "27:00", "56:03", "1:26:22", "2:04:13", "4:16:03") },
            { 36, new VdotEntry(36, "7:14", "7:49", "15:23", "16:34", "26:22", "54:44", "1:24:20", "2:01:19", "4:10:19") },
            { 37, new VdotEntry(37, "7:04", "7:38", "15:01", "16:11", "25:46", "53:29", "1:22:24", "1:58:34", "4:04:50") },
            { 38, new VdotEntry(38, "6:54", "7:27", "14:41", "15:49", "25:12", "52:17", "1:20:33", "1:55:55", "3:59:35") },
            { 39, new VdotEntry(39, "6:44", "7:17", "14:21", "15:29", "24:39", "51:09", "1:18:47", "1:53:24", "3:54:34") },
            { 40, new VdotEntry(40, "6:35", "7:07", "14:03", "15:09", "24:08", "50:03", "1:17:06", "1:50:59", "3:49:45") },
            { 41, new VdotEntry(41, "6:27", "6:58", "13:45", "14:49", "23:38", "49:01", "1:15:29", "1:48:40", "3:45:09") },
            { 42, new VdotEntry(42, "6:19", "6:49", "13:28", "14:31", "23:09", "48:01", "1:13:56", "1:46:27", "3:40:43") },
            { 43, new VdotEntry(43, "6:11", "6:41", "13:11", "14:13", "22:41", "47:04", "1:12:27", "1:44:20", "3:36:28") },
            { 44, new VdotEntry(44, "6:03", "6:32", "12:55", "13:56", "22:15", "46:09", "1:11:02", "1:42:17", "3:32:23") },
            { 45, new VdotEntry(45, "5:56", "6:25", "12:40", "13:40", "21:50", "45:16", "1:09:40", "1:40:20", "3:28:26") },
            { 46, new VdotEntry(46, "5:49", "6:17", "12:26", "13:25", "21:25", "44:25", "1:08:22", "1:38:27", "3:24:39") },
            { 47, new VdotEntry(47, "5:42", "6:10", "12:12", "13:10", "21:02", "43:36", "1:07:06", "1:36:38", "3:21:00") },
            { 48, new VdotEntry(48, "5:36", "6:03", "11:58", "12:55", "20:39", "42:50", "1:05:53", "1:34:53", "3:17:29") },
            { 49, new VdotEntry(49, "5:30", "5:56", "11:45", "12:41", "20:18", "42:04", "1:04:44", "1:33:12", "3:14:06") },
            { 50, new VdotEntry(50, "5:24", "5:50", "11:33", "12:28", "19:57", "41:21", "1:03:36", "1:31:35", "3:10:49") },
            { 51, new VdotEntry(51, "5:18", "5:44", "11:21", "12:15", "19:36", "40:39", "1:02:31", "1:30:02", "3:07:39") },
            { 52, new VdotEntry(52, "5:13", "5:38", "11:09", "12:02", "19:17", "39:59", "1:01:29", "1:28:31", "3:04:36") },
            { 53, new VdotEntry(53, "5:07", "5:32", "10:58", "11:50", "18:58", "39:20", "1:00:28", "1:27:04", "3:01:39") },
            ...
            { 78, new VdotEntry(78, "3:38", "3:56", "7:48", "8:25", "13:35", "28:17", "43:20", "1:02:15", "2:10:27") },
            { 79, new VdotEntry(79, "3:36", "3:53", "7:43", "8:20", "13:26", "27:59", "42:52", "1:01:34", "2:09:02") },
            { 80, new VdotEntry(80, "3:34", "3:51", "7:37", "8:14", "13:17", "27:41", "42:25", "1:00:54", "2:07:38") },
            { 81, new VdotEntry(81, "3:31", "3:48", "7:32", "8:08", "13:09", "27:24", "41:58", "1:00:15", "2:06:17") },
            { 82, new VdotEntry(82, "3:29", "3:46", "7:27", "8:03", "13:01", "27:07", "41:32", "59:38", "2:04:57") },
            { 83, new VdotEntry(83, "3:27", "3:44", "7:23", "7:58", "12:53", "26:51", "41:06", "59:01", "2:03:40") },
            { 84, new VdotEntry(84, "3:25", "3:41", "7:18", "7:53", "12:45", "26:34", "40:42", "58:25", "2:02:24") },
            { 85, new VdotEntry(85, "3:23", "3:39", "7:14", "7:48", "12:37", "26:19", "40:17", "57:50", "2:01:10") }
        }.ToImmutableDictionary();
    }

    // Training paces lookup table (per VDOT value)
    private static readonly ImmutableDictionary<int, TrainingPaces> TrainingPacesTable = CreateTrainingPacesTable();
    
    private static ImmutableDictionary<int, TrainingPaces> CreateTrainingPacesTable()
    {
        return new Dictionary<int, TrainingPaces>()
    {
